...
**Decisions tổng hợp (030 + mobile surfaces):** `docs/decisions/single-post-layout-and-mobile-surfaces.md`

**Brainstorm rộng hơn (end-user deep customization):** `docs/workflows/ideation-end-user-deep-customization.md` — chưa quyết định.
