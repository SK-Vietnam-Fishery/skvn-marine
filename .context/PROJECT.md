...
- Quote UI/editor controls are current 0.5.1 scope; CF7/CFDB7 are deferred until after 0.5.1; n8n is deferred until after 1.0.0.
...
- Sidebar/editor control scope for quote UI and marketing-owned surfaces.
