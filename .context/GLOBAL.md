...
- `.context/planning/016_VERSION_1_2_3_FEATURE_SHOWCASE_PLANNING.md` — pending `1.2.3` Feature Showcase plan. Source is parked under `src/feature-showcase/` but must remain unregistered during `1.2.1`.
